...
const nominations = [
  ...
  { id: 4, emoji: <img src="https://cdn.poehali.dev/projects/2ddec51a-c1ca-482a-ac82-361f593e7be2/bucket/7cc337e3-8f03-45f7-bff9-b629a11a93ca.png" className="w-20 h-20 object-contain inline-block" />, title: 'Магия сцены',            desc: 'Выдающаяся роль или режиссёрская работа в кино или сериалах.',     color: '#ff3cac', tags: ['Арт-хаус','Мейнстрим','Короткий метр'] },
