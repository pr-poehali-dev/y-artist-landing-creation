...
const nominations = [
  ...
  { id: 2, emoji: <img src="https://cdn.poehali.dev/projects/2ddec51a-c1ca-482a-ac82-361f593e7be2/bucket/3e05687b-f950-403b-8a53-96d5ce5c2e14.png" className="w-20 h-20 object-contain inline-block" />, title: 'Движение и пластика',  desc: 'Лучший хореограф или танцевальный коллектив сезона.',              color: '#3cf0ff', tags: ['Хип-хоп','Классика','Современный'] },
  ...
  { id: 4, emoji: <img src="https://cdn.poehali.dev/projects/2ddec51a-c1ca-482a-ac82-361f593e7be2/bucket/9d847824-036d-48c8-8250-6cc8a02f5c9b.png" className="w-20 h-20 object-contain inline-block" />, title: 'Магия ткани',            desc: 'Выдающаяся роль или режиссёрская работа в кино или сериалах.',     color: '#ff3cac', tags: ['Арт-хаус','Мейнстрим','Короткий метр'] },
  { id: 5, emoji: <img src="https://cdn.poehali.dev/projects/2ddec51a-c1ca-482a-ac82-361f593e7be2/bucket/d4df2a51-2c7f-4437-a520-492bcfb0aa90.png" className="w-20 h-20 object-contain inline-block" />, title: 'Живая сцена',          desc: 'Лучшее живое выступление или концертный тур года.',                color: '#3cf0ff', tags: ['Рок','Инди','Электроника'] },
