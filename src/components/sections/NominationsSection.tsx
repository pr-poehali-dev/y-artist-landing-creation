...
const nominations = [
  ...
  { id: 3, emoji: <img src="https://cdn.poehali.dev/projects/2ddec51a-c1ca-482a-ac82-361f593e7be2/bucket/550de959-cfad-4835-a1b7-80742f66b711.png" className="w-24 h-24 object-contain inline-block" />, title: 'Театральный прорыв',   desc: 'Спектакль или актёрская работа, изменившая театральный ландшафт.', color: '#f5c842', tags: ['Драма','Комедия','Мюзикл'] },
