...
const nominations = [
  { id: 1, emoji: <img src="https://cdn.poehali.dev/projects/2ddec51a-c1ca-482a-ac82-361f593e7be2/bucket/9a355d9f-119b-45c7-8cf6-f6c55e53f4d3.png" className="w-12 h-12 object-contain inline-block" />, title: 'Голос года',          desc: 'Лучший вокальный исполнитель или коллектив, покоривший сцену.',    color: '#ff3cac', tags: ['Поп','R&B','Джаз'] },
