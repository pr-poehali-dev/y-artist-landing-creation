...
const nominations = [
  ...
  { id: 5, emoji: <img src="https://cdn.poehali.dev/projects/2ddec51a-c1ca-482a-ac82-361f593e7be2/bucket/d4df2a51-2c7f-4437-a520-492bcfb0aa90.png" className="w-20 h-20 object-contain inline-block" />, title: 'Гармония сердца',          desc: 'Лучшее инструментальное исполнение.',                color: '#3cf0ff', tags: ['Рок','Инди','Электроника'] },
  { id: 6, emoji: <img src="https://cdn.poehali.dev/projects/2ddec51a-c1ca-482a-ac82-361f593e7be2/bucket/1919eb31-b78a-4757-b949-0402f0ad0e5c.png" className="w-24 h-24 object-contain inline-block" />, title: 'Творческий Олимп',        desc: 'Лучшая работа в номинациях ИЗО и ДПИ.',              color: '#f5c842', tags: ['Дебют','Независимые','Молодые'] },
];
