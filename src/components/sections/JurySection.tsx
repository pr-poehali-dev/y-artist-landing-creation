const jury = [
  {
    ...
    desc: 'Народная артистка России, художественный руководитель ансамбля «Русская душа»',
  ...
  {
    name: 'Денис Александров',
    role: 'Председатель ф-л АНО «Всероссийское хоровое общество» в ЯНАО',
    desc: 'Председатель ф-л АНО «Всероссийское хоровое общество» в ЯНАО, член российского музыкального союза',
  ...
  },
  {
    ...
    desc: 'Доцент ФГБОУ ВО «Московская государственная академия хореографии», член союза театральных деятелей Российской Федерации, кандидат искусствоведения',
