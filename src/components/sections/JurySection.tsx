const jury = [
  ...
  },
  {
    ...
    role: 'Председатель ф-л АНО «Всероссийское хоровое общество» в НАО',
    desc: 'Председатель ф-л АНО «Всероссийское хоровое общество» в НАО, член российского музыкального союза',
